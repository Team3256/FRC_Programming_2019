...
//		pathGenerator.addPoint(new Vector(-51.8,163.233182));
		pathGenerator.addPoint(new Vector(-51.8,127));
		pathGenerator.addPoint(new Vector(-51.8,130));
		pathGenerator.addPoint(new Vector(-51.8,135));
		pathGenerator.addPoint(new Vector(-51.8,139));
