...
import static frc.team3256.robot.constants.Constants.*;
...
public class DriveTrain extends DriveTrainBase implements Loop {
    ...
    private DriveTrain() {
        ...
        */
        shifter = new DoubleSolenoid(pcmId, kShifterForward, kShifterReverse);
    ...
    @Override
    public frc.team3256.warriorlib.math.Rotation getRotationAngle() {
        return null;
    }
