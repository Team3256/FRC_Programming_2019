...
public class PivotStateBased extends SubsystemBase {
    ...
    private static PivotStateBased instance;

    public static PivotStateBased getInstance() {
        return instance == null ? instance = new PivotStateBased() : instance;
    }

    private PivotStateBased() {
    ...
    public void hold(double encoderValue) {
        mMaster.selectProfileSlot(kHatchHoldPort, 0);
        mMaster.set(ControlMode.Position, encoderValue);
    }

    public void setPosition(double encoderPos) {
        mMaster.selectProfileSlot(kHatchHoldPort, 0);
        mMaster.set(ControlMode.Position, encoderPos);
    }
    ...
    public double angleToSensorUnits(double degrees) {
