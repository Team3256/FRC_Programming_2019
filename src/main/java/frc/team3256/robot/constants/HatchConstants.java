...
public class HatchConstants {
    public static final double kHatchP = 1.7;
    public static final double kHatchI = 0.0;
    public static final double kHatchD = 0.001;
    public static final double kHatchF = 0.00008;
    ...
    public static final double kPositionFloorIntakeHatch = -25;
